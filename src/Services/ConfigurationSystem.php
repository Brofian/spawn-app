...
class ConfigurationSystem {
    ...
    protected function configurationEntityToValue(ConfigurationEntity $entity) {
        switch ($entity->getType()) {
            case ConfigurationManager::TYPE_NUMBER:
                return (double)$entity->getValue();
            case ConfigurationManager::TYPE_BOOL:
                return (bool)$entity->getValue();
            default:
                // ConfigurationManager::TYPE_TEXT,
                // ConfigurationManager::TYPE_SELECT,
                // ConfigurationManager::TYPE_ENTITY
